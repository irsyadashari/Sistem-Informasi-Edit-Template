...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="<?php echo base_url();?>assets/css/ace" />
		...
		function cekform()
		{
			if(!$("#username").val())
			{
				alert('username tidak boleh kosong, cukup hatimu saja yang kosong');
				$("#username").focus();
				return false;
			}
			if(!$("#password").val())
			{
				alert('password harus ada, cukup dia saja yang sudah tiada');
				$("#password").focus();
				return false;
			}
		}
